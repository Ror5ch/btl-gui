...
LpGBT3_button0 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button0, output_textbox, 3))
LpGBT3_button1 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button1, output_textbox, 3))
LpGBT3_button2 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button2, output_textbox, 3))
...
LpGBT3_button6 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button6, output_textbox, 3))
LpGBT3_button7 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button7, output_textbox, 3))
LpGBT3_button8 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button8, output_textbox, 3))
LpGBT3_button9 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button9, output_textbox, 3))
LpGBT3_button10 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button10, output_textbox, 3))
LpGBT3_button11 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button11, output_textbox, 3))
LpGBT3_button12 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button12, output_textbox, 3))
LpGBT3_button13 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button13, output_textbox, 3))
LpGBT3_button14 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button14, output_textbox, 3))
LpGBT3_button15 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: 
button_functions.LpGBTon_off_button(LpGBT3_button15, output_textbox, 3))
...
LpGBT3_button2_0 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_0, output_textbox, 3))
LpGBT3_button2_1 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_1, output_textbox, 3))
LpGBT3_button2_2 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_2, output_textbox, 3))
...
LpGBT3_button2_6 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_6, output_textbox, 3))
LpGBT3_button2_7 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_7, output_textbox, 3))
LpGBT3_button2_8 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_8, output_textbox, 3))
LpGBT3_button2_9 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_9, output_textbox, 3))
LpGBT3_button2_10 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_10, output_textbox, 3))
LpGBT3_button2_11 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_11, output_textbox, 3))
LpGBT3_button2_12 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_12, output_textbox, 3))
LpGBT3_button2_13 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_13, output_textbox, 3))
LpGBT3_button2_14 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_14, output_textbox, 3))
LpGBT3_button2_15 = tk.Button(LpGBT1_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button(LpGBT3_button2_15, output_textbox, 3))
...
LpGBT2_button0 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button0, output_textbox, 2))
LpGBT2_button1 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button1, output_textbox, 2))
LpGBT2_button2 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button2, output_textbox, 2))
LpGBT2_button3 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button3, output_textbox, 2))
LpGBT2_button4 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button4, output_textbox, 2))
LpGBT2_button5 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button5, output_textbox, 2))
LpGBT2_label6 = tk.Label(LpGBT2_GPIO_frame, width='10', text='output')
LpGBT2_button7 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button7, output_textbox, 2))
LpGBT2_button8 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button8, output_textbox, 2))
LpGBT2_button9 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button9, output_textbox, 2))
LpGBT2_button10 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button10, output_textbox, 2))
LpGBT2_button11 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button11, output_textbox, 2))
LpGBT2_label12 = tk.Label(LpGBT2_GPIO_frame, width='10', text='output')
LpGBT2_button13 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button13, output_textbox, 2))
LpGBT2_label14 = tk.Label(LpGBT2_GPIO_frame, width='10', text='output')
LpGBT2_button15 = tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTon_off_button(LpGBT2_button15, output_textbox, 2))
...
LpGBT2_button_array2 = [
    tk.Button(LpGBT2_GPIO_frame, bg="white", command=lambda: button_functions.LpGBTset_clr_button), 
    tk.Button(LpGBT2_GPIO_frame, bg="white"),
    tk.Button(LpGBT2_GPIO_frame, bg="white"), 
    tk.Button(LpGBT2_GPIO_frame, bg="white"),
    tk.Button(LpGBT2_GPIO_frame, bg="white"), 
    tk.Button(LpGBT2_GPIO_frame, bg="white"),
    tk.Label(LpGBT2_GPIO_frame, text=""), 
    tk.Button(LpGBT2_GPIO_frame, bg="white"),
    tk.Button(LpGBT2_GPIO_frame, bg="white"), 
    tk.Button(LpGBT2_GPIO_frame, bg="white"),
    tk.Button(LpGBT2_GPIO_frame, bg="white"), 
...
### Refresh Button ###
AnIO_refresh_button = tk.Button(tab4, text="Refresh", command=button_functions.AnIO_refresh)
...
GPIO_enter = tk.Button(GBT_SCA4_scripts_frame, bg="white", text="GPIO enter", command=GPIOenter)
...
GPIO_enter2 = tk.Button(GBT_SCA1_scripts_frame, bg="white", text="GPIO enter", command=GPIOenter)
