...
def Init_EC_IC_moduls(sentarg, hw):
    if sentarg == 2:
...
#####################################################################
def EC_Tx_Elink_Header(sentarg, hw):
    if sentarg == 2:
...
#####################################################################
def EC_Tx_SCA_Header(sentarg, hw):
    if sentarg == 2:
...
#####################################################################
def SCA_Connect_CMD(sentarg, hw):
    if sentarg == 2:
...
#####################################################################
def EC_Rx_SCA_Header(sentarg, hw):
    if sentarg == 2:
